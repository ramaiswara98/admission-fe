    ...
    if (fullName !== "" && email !== "" && password !== "" && type !== "") {
      ...
      const users =await usersAPI.createNewUser(data);
        if(users.status == "success"){
            setAlert(<Alert type={'success'} message={'Account succesfully created'}/>)
      ...
      console.log(data);
        ...
        setAlert(<Alert type={'danger'} message={"Please fill up all the form"}/>)
    }
  };
    ...
    <div>
      ...
      <div className="flex flex-row gap-1 h-screen">
        ...
        <div className="bg-white w-full py-4 px-4">
          <p className="font-invisible text-2xl">Create Users</p>
